...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Real quantum-physics computing plus a 3D/4D synthetic civilization. © Evan Ketchum — All Rights Reserved." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Ketchum's Quantum Physics Labs · Powered by Quantara" },
      { name: "twitter:description", content: "Real quantum-physics computing plus a 3D/4D synthetic civilization. © Evan Ketchum — All Rights Reserved." },
