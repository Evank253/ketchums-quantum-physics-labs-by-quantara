...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "copyright", content: "© 2026 Evan Ketchum — All Rights Reserved" },
      ...
      { property: "og:description", content: "Ketchum's Quantum Physics Labs — real quantum-physics computing (QED/QCD/KVE engines, CERN-in-a-Pocket precision sweeps) plus a 3D/4D synthetic civilization, powered by Quantara." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Ketchum's Quantum Physics Labs · Powered by Quantara" },
      { name: "twitter:description", content: "Ketchum's Quantum Physics Labs — real quantum-physics computing (QED/QCD/KVE engines, CERN-in-a-Pocket precision sweeps) plus a 3D/4D synthetic civilization, powered by Quantara." },
          ...
          "@graph": [
            {
              ...
              alternateName: ["Quantara", "Ketchum's QED Engine"],
            ...
            },
            {
              ...
              url: "https://ketchums-quantum-physics-labs-by-quantara.lovable.app",
              name: "Ketchum's Quantum Physics Labs · Quantara",
